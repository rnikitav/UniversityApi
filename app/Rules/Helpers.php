...
class Helpers
{
    ...
    public static string $requiredFile2mbWebP = 'required|file|mimes:webp|max:2048';
    public static string $sometimesFile2mbWebP = 'sometimes|file|mimes:webp|max:2048';
}
